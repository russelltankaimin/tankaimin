    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="laptop:mt-20 mt-10 flex flex-col laptop:flex-row items-start">
          <div className="flex-grow">
            <div className="mt-5">
              <h1
                ref={textOne}
                className="text-2xl tablet:text-6xl laptop:text-6xl laptopl:text-3xl p-1 ml-1 tablet:p-2 text-bold w-4/5 mob:w-full laptop:w-4/5"
              >
                {data.headerTaglineOne}
              </h1>
              <h1
                ref={textTwo}
                className="text-3xl tablet:text-6xl laptop:text-6xl laptopl:text-3xl p-1 ml-1 tablet:p-2 text-bold w-full laptop:w-4/5"
              >
        ...
        <h1 className="tablet:m-10 text-2xl text-bold">Work.</h1>
          ...
          <div className="mt-5 laptop:mt-10 grid grid-cols-1 tablet:grid-cols-2 gap-4 m-7">
