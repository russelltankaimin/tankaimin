      ...
      <>
        ...
        >
          ...
          <div className="mt-10">
            ...
            <h3
              ref={text}
              className="mx-auto mob:p-2 text-bold text-2xs laptop:text-2xs w-full"
            >
            The very nice images are generated by Dall-E, some taken from DreamingAI and Quanta Magazine
            </h3>
          </div>
        </div>
        {process.env.NODE_ENV === "development" && mounted && (
